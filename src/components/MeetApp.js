...
class MeetApp extends Component{
    domain = 'meet.jit.si';
    api = {};
    ...
    startMeet = () => {
        const options = {
            ...
            configOverwrite: { 
                ...
                logoClickUrl: 'http://aiverse.co.in',
                  // The url used for the image used as logo
                 logoImageUrl: 'https://github.com/Anurag131277/aiv-neet/logo2.png',
             },
            interfaceConfigOverwrite: {
                // overwrite interface properties
                DEFAULT_LOGO_URL: 'https://github.com/Anurag131277/aiv-neet/logo2.png',
                DEFAULT_WELCOME_PAGE_LOGO_URL: 'https://github.com/Anurag131277/aiv-neet/logo2.png',
                APP_NAME: 'AI-Verse Meet',
    ...
    handleVideoConferenceLeft = () => {
        ...
        return window.location.href="/aiv-neet/thank-you"
    }
    ...
    render() {
        ...
        return (
            ...
            <header className="nav-bar">
                <p className="item-left heading">AI-verse MEET</p>
            </header>
